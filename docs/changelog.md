...
- [#2475](https://github.com/modularml/mojo/issues/2487) Fix `remove a 
  footgun caused by implicit conversion by changing msg to keyword 
  argument in assert_true/assert_false/ ..`
