...
- ```Tuple``` now supports ```__contains__```([PR #2709](https://github.com/modularml/mojo/pull/2709) by
  [@rd4com](https://github.com/rd4com))
  ```mojo
  var x = Tuple(1,True,"Mojo is awesome")
  if "Mojo is awesome" in x: print("Mojo is awesome 🔥")
  ```
