...
[`magic`](/magic) is our CLI tool that makes is really simple to get started
with Mojo. With just a couple commands, you'll create a new project with its
own virtual environment that includes everything you need to get started.
