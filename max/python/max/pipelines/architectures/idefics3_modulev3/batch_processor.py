...
# ===----------------------------------------------------------------------=== #
"""Input batching for Idefics3 ModuleV3 pipeline models."""
...
from max.pipelines.lib.interfaces.batch_processor import (
    BatchProcessor,
    modulev3_idefics3_language_symbolic_inputs,
...
class Idefics3ModuleV3BatchProcessor(
    ...
    def get_language_symbolic_inputs(
        ...
        *,
        ...
        return modulev3_idefics3_language_symbolic_inputs(
            kv_params=kv_params,
    ...
    def _prepare_vision_inputs(
        self, context_batch: Sequence[TextAndVisionContext], device0: Device
    ) -> Buffer | None:
