...
[`error_interaction.mojo`](https://github.com/modular/modular/blob/main/Mojo/docs/site/code/manual/errors/error_interaction.mojo).
:::
...
[`resource_guard.mojo`](https://github.com/modular/modular/blob/main/Mojo/docs/site/code/manual/errors/resource_guard.mojo).
