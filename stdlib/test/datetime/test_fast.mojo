...
fn test_iso64() raises:
    ...
    assert_equal(ref, DateTime64.from_iso[iso_format]())
...
fn test_iso32() raises:
    ...
    var iso_str = "1970-01-01T00:00:00+00:00"
    var iso_format = IsoFormat(IsoFormat.YYYY_MM_DD_T_MM_HH_SS_TZD)
    assert_equal(ref, DateTime32.from_iso[iso_format]())
    assert_equal(iso_str, ref.to_iso[iso_format]())
...
fn test_iso16() raises:
    ...
    var iso_str = "1970-01-01T00:00:00+00:00"
    var iso_format = IsoFormat(IsoFormat.YYYY_MM_DD_T_MM_HH_SS_TZD)
    assert_equal(ref, DateTime16.from_iso[iso_format]())
    assert_equal(iso_str, ref.to_iso[iso_format]())
...
fn test_iso8() raises:
    ...
    var iso_str = "1970-01-01T00:00:00+00:00"
    var iso_format = IsoFormat(IsoFormat.YYYY_MM_DD_T_MM_HH_SS_TZD)
    assert_equal(ref, DateTime8.from_iso[iso_format]())
    assert_equal(iso_str, ref.to_iso[iso_format]())
