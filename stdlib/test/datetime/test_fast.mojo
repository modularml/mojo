...
fn test_add64() raises:
    ...
    print(result.m_seconds)
    print(offset_0.m_seconds)
    ...
    result = DateTime64(2023, 2, 28) + DateTime64(day=1)
    ...
    # test normal month
    result = DateTime64(2024, 5, 31) + DateTime64(day=1)
    ...
    # test december
    result = DateTime64(2024, 12, 31) + DateTime64(day=1)
    ...
    result = DateTime64(9999, 12, 31) + DateTime64(day=1)
...
fn test_add32() raises:
    ...
    # test february not leapyear
    result = DateTime32(2023, 2, 28) + DateTime32(day=1)
    ...
    # test normal month
    result = DateTime32(2024, 5, 31) + DateTime32(day=1)
    ...
    # test december
    result = DateTime32(2024, 12, 31) + DateTime32(day=1)
    ...
    # test positive overflow pycal
    result = DateTime32(9999, 12, 31) + DateTime32(day=1)
...
fn test_subtract64() raises:
    ...
    # test february not leapyear
    result = DateTime64(2023, 3, 1) - DateTime64(day=1)
    ...
    # test normal month
    result = DateTime64(2024, 6, 1) - DateTime64(day=1)
    ...
    # test december
    result = DateTime64(2025, 1, 1) - DateTime64(day=1)
    ...
    result = DateTime64(1, 1, 1) - DateTime64(day=1)
    ...
    result = DateTime64(1970, 1, 1) - DateTime64(day=1)
    offset_0 = DateTime64(9999, 12, 31)
    assert_true(result == offset_0)
...
fn test_subtract32() raises:
    ...
    # test february not leapyear
    result = DateTime32(2023, 3, 1) - DateTime32(day=1)
    ...
    # test normal month
    result = DateTime32(2024, 6, 1) - DateTime32(day=1)
    ...
    # test december
    result = DateTime32(2025, 1, 1) - DateTime32(day=1)
    ...
    # test negative overflow pycal
    result = DateTime32(1, 1, 1) - DateTime32(day=1)
    ...
    # test negative overflow unixcal
    result = DateTime32(1970, 1, 1) - DateTime32(day=1)
    offset_0 = DateTime32(9999, 12, 31)
    assert_true(result == offset_0)
