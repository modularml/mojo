...
def test_range_len():
    # Usual cases
    assert_equal(range(10).__len__(), 10, msg="len(range(10))")
    assert_equal(range(0, 10).__len__(), 10, msg="len(range(0, 10))")
    ...
    assert_equal(range(-10).__len__(), 0, msg="len(range(-10))")
    assert_equal(range(0, 0).__len__(), 0, msg="len(range(0, 0))")
    assert_equal(range(10, 0).__len__(), 0, msg="len(range(10, 0))")
    assert_equal(range(0, 0, 1).__len__(), 0, msg="len(range(0, 0, 1))")
    # FIXME(#38392)
    ...
    assert_equal(range(5, 10, 20).__len__(), 1, msg="len(range(5, 10, 20))")
    assert_equal(range(10, 5, -20).__len__(), 1, msg="len(range(10, 5, -20))")


def test_range_getitem():
    # Usual cases
    assert_equal(range(10)[3], 3, msg="range(10)[3]")
    assert_equal(range(0, 10)[3], 3, msg="range(0, 10)[3]")
    assert_equal(range(5, 10)[3], 8, msg="range(5, 10)[3]")
    assert_equal(range(5, 10)[4], 9, msg="range(5, 10)[4]")
    assert_equal(range(10, 0, -1)[2], 8, msg="range(10, 0, -1)[2]")
    assert_equal(range(0, 10, 2)[4], 8, msg="range(0, 10, 2)[4]")
    assert_equal(range(38, -13, -23)[1], 15, msg="range(38, -13, -23)[1]")


def test_range_reversed():
    # Zero starting
    assert_equal(
        range(10).__reversed__().start, 9, msg="range(10).__reversed__().start"
    )
    assert_equal(
        range(10).__reversed__().end, -1, msg="range(10).__reversed__().end"
    )
    assert_equal(
        range(10).__reversed__().step, -1, msg="range(10).__reversed__().step"
    )
    # Sequential
    assert_equal(
    ...
    assert_equal(
        ...
        -8,
        msg="range(38, -13, -23).__reversed__().start",
    )
    assert_equal(
        range(38, -13, -23).__reversed__().end,
        61,
        msg="range(38, -13, -23).__reversed__().end",
    )
    assert_equal(
        range(38, -13, -23).__reversed__().step,
        23,
        msg="range(38, -13, -23).__reversed__().step",
    )
    ...
    fn test_sum_reversed(start: Int, end: Int, step: Int) raises:
        ...
        assert_equal(forward_sum, backward_sum, msg="forward_sum, backward_sum")
