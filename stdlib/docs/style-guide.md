...
Note that this is also included in the pre-commit. So if you have `pre-commit` enabled, this will run
automatically before committing. If you want to run it manually with pre-commit, just run
