...
struct PythonObject(
    ...
    fn __init__(out self, strref: StringRef):
        ...
        """
        cpython = _get_global_python_itf().cpython()
        self.py_object_ptr = cpython.PyUnicode_DecodeUTF8(strref)
    ...
    fn __init__(out self, string: String):
        ...
        """
        cpython = _get_global_python_itf().cpython()
        self.py_object_ptr = cpython.PyUnicode_DecodeUTF8(
    ...
    fn __int__(self) -> Int:
        ...
        """
        cpython = _get_global_python_itf().cpython()
        return cpython.PyLong_AsSsize_t(self.py_object_ptr)
    ...
    fn _get_type_name(self) -> String:
        ...
        var actual_type = cpython.Py_TYPE(self.unsafe_py_object_ptr())
