...
fn debug_assert[
    *stringable: Stringable
](cond: Bool, *message_parts: *stringable, sep: StringLiteral = " "):
    ...
    Args:
        ...
        message_parts: The message parts to convert to `String` and
            concatenate before display on failure.
        sep: The separator to use when concatenating the message parts.
            Default is " ".
    """
