...
fn bin(value: Scalar, /, *, prefix: StaticString = "0b") -> String:
    ...
    """
    var result = String()
    bin(value, writer=result, prefix=prefix)
    return result^
...
fn hex(value: Scalar, /, *, prefix: StaticString = "0x") -> String:
    ...
    """
    var result = String()
    hex(value, writer=result, prefix=prefix)
    return result^
...
fn oct(value: Scalar, /, *, prefix: StaticString = "0o") -> String:
    ...
    """
    var result = String()
    oct(value, writer=result, prefix=prefix)
    return result^
...
fn _try_format_int(
    ...
    *,
    ...
    var string = String()
    _try_write_int(string, value, radix, digit_chars=digit_chars, prefix=prefix)
    return string^
